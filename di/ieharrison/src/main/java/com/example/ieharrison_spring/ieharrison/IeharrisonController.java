  ...
  @ApiResponses(
    {
      @ApiResponse(
        responseCode = "200",
        description = "Ieharrison created successfully"
      ),
      @ApiResponse(
        responseCode = "205",
        description = "ERROR: Ieharrison partially created (fields missing)"
      ),
    }
  )
  ...
  @ApiResponses(
    {
      @ApiResponse(
        responseCode = "200",
        description = "Ieharrison removed succesfully"
      ),
      @ApiResponse(
        responseCode = "209",
        description = "ERROR: ieharrison not removed"
      ),
    }
  )
  ...
  @ApiResponses(
    {
      @ApiResponse(
        responseCode = "200",
        description = "Ieharrison found succesfully"
      ),
      @ApiResponse(
        responseCode = "209",
        description = "ERROR: ieharrison not found"
      ),
    }
  )
  ...
  @ApiResponses(
    {
      @ApiResponse(
        responseCode = "200",
        description = "Ieharrison elements found succesfully"
      ),
      @ApiResponse(
        responseCode = "209",
        description = "ERROR: no elements at ieharrison"
      ),
    }
  )
  ...
  @ApiResponses(
    {
      @ApiResponse(
        responseCode = "200",
        description = "Ieharrison edited succesfully"
      ),
      @ApiResponse(
        responseCode = "201",
        description = "ERROR: ieharrison partially edited"
      ),
      @ApiResponse(
        responseCode = "209",
        description = "ERROR: ieharrison not found"
  ...
  @ApiResponses(
    {
      @ApiResponse(
        responseCode = "200",
        description = "All Ieharrisons removed successfully"
      ),
      @ApiResponse(
        responseCode = "204",
        description = "ERROR: No Ieharrisons to remove"
      ),
    }
  )
  ...
  @ApiResponses(
    {
      ...
      @ApiResponse(
        responseCode = "201",
        description = "Balance initialized and increased successfully"
      ),
  ...
  @ApiResponses(
    {
      @ApiResponse(
        responseCode = "200",
        description = "Balance reduced successfully and positive"
      ),
      @ApiResponse(
        responseCode = "201",
        description = "Balance reduced and negative"
      ),
      @ApiResponse(responseCode = "209", description = "ID does not exist"),
    }
  )
  ...
  @ApiResponses(
    {
      @ApiResponse(
        responseCode = "200",
        description = "Average balance succesfully found"
      ),
      @ApiResponse(
        responseCode = "201",
        description = "Average balance is negative"
      ),
