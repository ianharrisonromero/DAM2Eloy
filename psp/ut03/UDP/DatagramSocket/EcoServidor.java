/* dos clases, una cliente envía una cadena y espera respuesta, y otra servidor que hace eco
(un while true en el servidor, y a esa dirección ip responde con la misma cadena, y con 
