...
public class Client {
    ...
    public static void main(String[] args) {
        ...
        PrimoInterface observerPrimo = new ObserverPrimo();

        // objetoDeClaseAnonimaQueImplementaPrimoInterface
        PrimoInterface objetoClaseAnonima = new PrimoInterface() {
            @Override
            public void update(int numberPrimo) {
                System.out.println(" NEW PRIME : " + numberPrimo);
            }
        };
        PrimoInterface objetoAnonimaAleman = (int numberPrimo) -> {
            System.out.println(" NUVEN PRIMEN : " + numberPrimo);

        };

        listaPrimos.add(objetoClaseAnonima);
        listaPrimos.add(objetoAnonimaAleman);
