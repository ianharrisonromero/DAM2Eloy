public class UsuarioBanco implements Runnable {
    ...
    public void retirar(int CANTIDAD_A_RETIRAR) {
        if (MainBanco.saldo >= CANTIDAD_A_RETIRAR) {
            MainBanco.saldo -= CANTIDAD_A_RETIRAR;
            System.out.println(
                    "Retiro OK hecho por : " + Thread.currentThread() + ", saldo ahora es : " + MainBanco.saldo);
        } else {
